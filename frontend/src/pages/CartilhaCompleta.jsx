...
const CartilhaCompleta = () => {
  ...
  return (
    <div className="min-h-screen bg-white py-8 print:py-4">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 print:px-2">
        
        {/* Header */}
        <div className="text-center mb-12 print:mb-6">
          <div className="inline-flex items-center gap-3 mb-4">
            <BookOpen className="h-12 w-12 text-blue-600 print:h-8 print:w-8" />
            <h1 className="text-4xl font-bold text-gray-900 print:text-2xl">Cartilha de Segurança Digital</h1>
          </div>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-6 print:text-base print:mb-4">
            Um guia completo para navegar com segurança no mundo digital
          </p>
        ...
        <Card className="mb-8 print:mb-4 print:shadow-none print:border-gray-300">
          ...
          <CardContent className="space-y-6 print:space-y-3">
            <div className="bg-blue-50 border-l-4 border-blue-400 p-6 rounded-lg print:p-3 print:bg-gray-50">
            ...
            <div className="grid md:grid-cols-2 gap-6 print:gap-3">
              <div className="bg-green-50 p-6 rounded-lg print:p-3 print:bg-gray-50">
                <h3 className="text-xl font-semibold text-green-800 mb-4 print:text-lg print:mb-2">🎯 Objetivos desta Cartilha</h3>
                <ul className="space-y-2 text-green-700 print:text-black print:space-y-1">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0 print:h-4 print:w-4" />
                    <span>Identificar golpes antes de cair neles</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0 print:h-4 print:w-4" />
                    <span>Proteger seus dados pessoais e financeiros</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0 print:h-4 print:w-4" />
                    <span>Usar a tecnologia com segurança e confiança</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0 print:h-4 print:w-4" />
                    <span>Reconhecer ameaças comuns na internet</span>
                  </li>
                </ul>
              </div>

              <div className="bg-yellow-50 p-6 rounded-lg print:p-3 print:bg-gray-50">
                <h3 className="text-xl font-semibold text-yellow-800 mb-4 print:text-lg print:mb-2 print:text-black">📖 Como Usar Esta Cartilha</h3>
                <ul className="space-y-2 text-yellow-700 print:text-black print:space-y-1">
                  <li>• Leia cada seção com calma</li>
                  <li>• Pratique as dicas apresentadas</li>
                  <li>• Mantenha esta cartilha sempre à mão</li>
        ...
        <Card className="mb-8 print:mb-4 print:shadow-none print:border-gray-300">
          <CardHeader className="print:pb-2">
            <CardTitle className="flex items-center gap-2 text-red-600 text-2xl print:text-xl">
          ...
          <CardContent className="space-y-6 print:space-y-3">
            <div className="bg-red-50 border-l-4 border-red-400 p-6 print:p-3 print:bg-gray-50">
              <h3 className="text-xl font-semibold text-red-800 mb-3 print:text-lg print:mb-2 print:text-black">🎣 Definição</h3>
              <p className="text-lg text-red-700 print:text-base print:text-black">
                <strong>Phishing é como a "pescaria" de golpistas na internet.</strong> Eles "iscam" suas vítimas 
                com mensagens falsas que parecem verdadeiras para roubar dados pessoais.
              </p>
            </div>

            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-6 print:p-3 print:bg-gray-50">
              <h3 className="text-xl font-semibold text-yellow-800 mb-4 print:text-lg print:mb-2 print:text-black">🔍 Como Identificar um Phishing</h3>
              <div className="grid md:grid-cols-2 gap-6 print:gap-3">
                <div>
                  <h4 className="font-medium text-yellow-700 mb-2 print:text-black">Sinais de Alerta:</h4>
                  <ul className="space-y-2 text-yellow-600 print:text-black print:space-y-1">
                    <li className="flex items-start gap-2 print:text-sm">
                      <Badge variant="destructive" className="text-xs print:bg-gray-200 print:text-black">URGÊNCIA</Badge>
                      <span className="text-sm">"Sua conta será bloqueada em 24 horas!"</span>
                    </li>
                    <li className="flex items-start gap-2 print:text-sm">
                      <Badge variant="destructive" className="text-xs print:bg-gray-200 print:text-black">REMETENTE</Badge>
                      <span className="text-sm">banco.verificacao@email.com ❌</span>
                    </li>
                    <li className="flex items-start gap-2 print:text-sm">
                      <Badge variant="destructive" className="text-xs print:bg-gray-200 print:text-black">LINKS</Badge>
                      <span className="text-sm">banco-seguro.tk ❌</span>
                    </li>
                  </ul>
                </div>
                <div>
                  <h4 className="font-medium text-green-700 mb-2 print:text-black">✅ Correto:</h4>
                  <ul className="space-y-2 text-green-600 print:text-black print:space-y-1 print:text-sm">
                    <li>• santander.com.br ✅</li>
                    <li>• Bancos NUNCA pedem senha por email</li>
                    <li>• Órgãos públicos não solicitam CPF por SMS</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-50 border-l-4 border-green-400 p-6 print:p-3 print:bg-gray-50">
              <h3 className="text-xl font-semibold text-green-800 mb-4 print:text-lg print:mb-2 print:text-black">🛡️ Como Se Proteger</h3>
              <div className="grid md:grid-cols-3 gap-4 print:gap-2 print:grid-cols-1">
                <div className="text-center p-4 bg-white rounded-lg border print:p-2 print:text-left">
                  <div className="text-2xl mb-2 print:hidden">🔍</div>
                  <h4 className="font-medium mb-1">SEMPRE verifique o remetente</h4>
                </div>
                <div className="text-center p-4 bg-white rounded-lg border print:p-2 print:text-left">
                  <div className="text-2xl mb-2 print:hidden">🚫</div>
                  <h4 className="font-medium mb-1">NUNCA clique em links suspeitos</h4>
                </div>
                <div className="text-center p-4 bg-white rounded-lg border print:p-2 print:text-left">
                  <div className="text-2xl mb-2 print:hidden">📞</div>
                  <h4 className="font-medium mb-1">LIGUE para o banco usando número oficial</h4>
                </div>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="mb-8 print:mb-4 print:shadow-none print:border-gray-300">
          <CardHeader className="print:pb-2">
            <CardTitle className="flex items-center gap-2 text-orange-600 text-2xl print:text-xl">
