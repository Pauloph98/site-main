...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <section className="bg-gradient-to-br from-blue-50 to-indigo-100 py-16 lg:py-24" role="region" aria-label="Seção principal">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Button 
                ...
                size="lg" 
                className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 text-lg font-medium rounded-lg transition-all duration-200 hover:scale-105 min-h-touch"
                aria-label="Começar a aprender sobre segurança digital"
              >
      ...
      <section className="py-16" role="region" aria-label="Funcionalidades do site">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="py-16 bg-white" role="region" aria-label="Estatísticas de inclusão digital">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-blue-50 rounded-lg border-2 border-blue-200" role="article" aria-label="66% dos idosos conectados">
              ...
              <div className="text-sm text-gray-700">IBGE 2023 (era 24,7% em 2016)</div>
            </div>
            ...
            <div className="text-center p-6 bg-red-50 rounded-lg border-2 border-red-200" role="article" aria-label="53% propensos a phishing">
              ...
              <div className="text-sm text-gray-700">Zulkipli et al. (2021)</div>
            </div>
            ...
            <div className="text-center p-6 bg-orange-50 rounded-lg border-2 border-orange-200" role="article" aria-label="80% denúncias por terceiros">
              ...
              <div className="text-sm text-gray-700">Agência Brasil (2024)</div>
            </div>
          </div>
        </div>
      </section>

      <section className="py-16 bg-gradient-to-r from-blue-600 to-blue-700" role="region" aria-label="Chamada para ação">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Button 
            ...
            size="lg" 
            variant="secondary" 
            className="bg-white text-blue-600 hover:bg-gray-50 px-8 py-3 text-lg font-medium rounded-lg transition-all duration-200 hover:scale-105 min-h-touch"
            aria-label="Ir para página de pesquisas"
          >
            Responder pesquisa
            <ArrowRight className="ml-2 h-5 w-5" aria-hidden="true" />
          </Button>
